...
void AFogOfWarTranningCharacter::BeginPlay()
{
	Super::BeginPlay();
	// MyCanvass = Cast<AMyCanvas>(UGameplayStatics::GetActorOfClass(GetWorld(), AMyCanvas::StaticClass()));
}

void AFogOfWarTranningCharacter::Tick(float DeltaSeconds)
{
	...
	// 	
	// 				FVector EndPoint1 = {ObstacleLocation.X + ObstacleLength, ObstacleLocation.Y + ObstacleWidth, ObstacleLocation.Z};
	// 				FVector EndPoint2 = {ObstacleLocation.X - ObstacleLength, ObstacleLocation.Y - ObstacleWidth, ObstacleLocation.Z};
	// 				FVector EndPoint3 = {ObstacleLocation.X + ObstacleLength, ObstacleLocation.Y - ObstacleWidth, ObstacleLocation.Z};
	// 				FVector EndPoint4 = {ObstacleLocation.X - ObstacleLength, ObstacleLocation.Y + ObstacleWidth, ObstacleLocation.Z};
	// 				
